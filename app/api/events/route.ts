...
export async function GET() {
    try {
        ...
        console.error(error);
        return NextResponse.json({ message: 'Event Retrieval Failed', error: error instanceof Error ? error.message : 'Unknown Error' }, { status: 500 });
    }
}

//TODO: A route that accepts a slug as input and returns the event details